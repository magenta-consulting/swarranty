...
class BrandSubCategoryAdmin extends BaseAdmin {
...
//        '_page' => 1,
	...
	public function toString($object) {
		return $object instanceof BrandSubCategory
			? $object->getName()
			: 'BrandSubCategory'; // shown in the breadcrumb on the create view
	}
