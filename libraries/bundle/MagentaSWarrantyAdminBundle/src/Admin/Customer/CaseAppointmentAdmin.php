    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ...
            ->add('serviceNote.description', null, [
             ...
             ->add('replacedParts', CollectionType::class,
                 [
                     'required' => false,
                     'constraints' => new Valid(),
                     'label' => 'form.label_parts_replaced',
                     'btn_catalogue' => 'CustomerCaseAppointmentReplacedPartsAdmin',
                 ], [
                     'edit' => 'inline',
                    'inline' => 'table',
                     //						'sortable' => 'position',
                     'link_parameters' => $this->getPersistentParameters(),
                     'admin_code' => ReplacedPartAdmin::class,
                     'delete' => null,
                 ]
             )

            ->add('serviceCost', MoneyType::class, [
                'label' => 'form.label_service_cost',
                'required' => false,
                'currency' => 'SGD',
            ])
            ->add('transportAndInspectionCost', MoneyType::class, [
                'label' => 'form.label_transport_inspection_cost',
                'required' => false,
                'currency' => 'SGD',
            ])
            ->add('partsCost', MoneyType::class, [
                'label' => 'form.label_parts_cost',
                'required' => false,
                'currency' => 'SGD',
            ])
