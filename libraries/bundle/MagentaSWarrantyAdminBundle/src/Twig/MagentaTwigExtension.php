...
class MagentaTwigExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFilter('privateMediumUrl', [$this, 'privateMediumUrl']),
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFunction('currentOrganisation', [$this, 'getCurrentOrganisation']),
            new \Twig_SimpleFunction('organisationBySubdomain', [$this, 'organisationBySubdomain']),
            new \Twig_SimpleFunction('privateMediumUrl', [$this, 'privateMediumUrl']),
        ];
    }
