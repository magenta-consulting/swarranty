...
{
	protected static $defaultName = 'magenta:user:promote';
	...
	protected function configure()
	{
		...
		$this
			->setName('magenta:user:promote')
			->setDescription('Promotes a user by adding a role')
			->setHelp(<<<'EOT'
The <info>magenta:user:promote</info> command promotes a user by adding a role
