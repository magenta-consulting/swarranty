...
class UserManipulator
{
	...
	public function create($username, $password, $email, $active, $superadmin)
	{
		...
		$this->dispatcher->dispatch(MagentaUserEvents::USER_CREATED, $event);
	...
	public function activate($username)
	{
		...
		$event = new UserEvent($user, $this->getRequest());
		$this->dispatcher->dispatch(MagentaUserEvents::USER_ACTIVATED, $event);
	}
	...
	public function deactivate($username)
	{
		...
		$event = new UserEvent($user, $this->getRequest());
		$this->dispatcher->dispatch(MagentaUserEvents::USER_DEACTIVATED, $event);
	}
	...
	public function changePassword($username, $password)
	{
		...
		$event = new UserEvent($user, $this->getRequest());
		$this->dispatcher->dispatch(MagentaUserEvents::USER_PASSWORD_CHANGED, $event);
	}
	...
	public function promote($username)
	{
		...
		$event = new UserEvent($user, $this->getRequest());
		$this->dispatcher->dispatch(MagentaUserEvents::USER_PROMOTED, $event);
	}
	...
	public function demote($username)
	{
		...
		$event = new UserEvent($user, $this->getRequest());
		$this->dispatcher->dispatch(MagentaUserEvents::USER_DEMOTED, $event);
	}
