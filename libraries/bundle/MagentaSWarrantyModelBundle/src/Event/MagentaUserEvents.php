...
namespace Magenta\Bundle\SWarrantyModelBundle\Event;

/**
 * Contains all events thrown in the FOSUserBundle.
 */
final class MagentaUserEvents {
	/**
	 ...
	 */
	const CHANGE_PASSWORD_INITIALIZE = 'magenta_user.change_password.edit.initialize';
	 ...
	 */
	const CHANGE_PASSWORD_SUCCESS = 'magenta_user.change_password.edit.success';
	 ...
	 */
	const CHANGE_PASSWORD_COMPLETED = 'magenta_user.change_password.edit.completed';
	 ...
	 */
	const GROUP_CREATE_INITIALIZE = 'magenta_user.group.create.initialize';
	 ...
	 * @Event("FOS\UserBundle\Event\FormEvent")
	 */
	const GROUP_CREATE_SUCCESS = 'magenta_user.group.create.success';
	 ...
	 */
	const GROUP_CREATE_COMPLETED = 'magenta_user.group.create.completed';
	 ...
	 * @Event("FOS\UserBundle\Event\FilterGroupResponseEvent")
	 */
	const GROUP_DELETE_COMPLETED = 'magenta_user.group.delete.completed';
	 ...
	 */
	const GROUP_EDIT_INITIALIZE = 'magenta_user.group.edit.initialize';
	 ...
	 * @Event("FOS\UserBundle\Event\FormEvent")
	 */
	const GROUP_EDIT_SUCCESS = 'magenta_user.group.edit.success';
	 ...
	 * @Event("FOS\UserBundle\Event\FilterGroupResponseEvent")
	 */
	const GROUP_EDIT_COMPLETED = 'magenta_user.group.edit.completed';
	 ...
	 * @Event("FOS\UserBundle\Event\GetResponseUserEvent")
	 */
	const PROFILE_EDIT_INITIALIZE = 'magenta_user.profile.edit.initialize';
	 ...
	 * @Event("FOS\UserBundle\Event\FormEvent")
	 */
	const PROFILE_EDIT_SUCCESS = 'magenta_user.profile.edit.success';
	 ...
	 * @Event("FOS\UserBundle\Event\FilterUserResponseEvent")
	 */
	const PROFILE_EDIT_COMPLETED = 'magenta_user.profile.edit.completed';
	 ...
	 */
	const REGISTRATION_INITIALIZE = 'magenta_user.registration.initialize';
	 ...
	 * @Event("FOS\UserBundle\Event\FormEvent")
	 */
	const REGISTRATION_SUCCESS = 'magenta_user.registration.success';
	 ...
	 * @Event("FOS\UserBundle\Event\FormEvent")
	 */
	const REGISTRATION_FAILURE = 'magenta_user.registration.failure';
	 ...
	 * @Event("FOS\UserBundle\Event\FilterUserResponseEvent")
	 */
	const REGISTRATION_COMPLETED = 'magenta_user.registration.completed';
	 ...
	 * @Event("FOS\UserBundle\Event\GetResponseUserEvent")
	 */
	const REGISTRATION_CONFIRM = 'magenta_user.registration.confirm';
	 ...
	 * @Event("FOS\UserBundle\Event\FilterUserResponseEvent")
	 */
	const REGISTRATION_CONFIRMED = 'magenta_user.registration.confirmed';
	 ...
	 * @Event("FOS\UserBundle\Event\GetResponseUserEvent")
	 */
	const RESETTING_RESET_REQUEST = 'magenta_user.resetting.reset.request';
	 ...
	 * @Event("FOS\UserBundle\Event\GetResponseUserEvent")
	 */
	const RESETTING_RESET_INITIALIZE = 'magenta_user.resetting.reset.initialize';
	 ...
	 * @Event("FOS\UserBundle\Event\FormEvent ")
	 */
	const RESETTING_RESET_SUCCESS = 'magenta_user.resetting.reset.success';
	 ...
	 * @Event("FOS\UserBundle\Event\FilterUserResponseEvent")
	 */
	const RESETTING_RESET_COMPLETED = 'magenta_user.resetting.reset.completed';
	 ...
	 * @Event("FOS\UserBundle\Event\UserEvent")
	 */
	const SECURITY_IMPLICIT_LOGIN = 'magenta_user.security.implicit_login';
	 ...
	 */
	const RESETTING_SEND_EMAIL_INITIALIZE = 'magenta_user.resetting.send_email.initialize';
	 ...
	 * @Event("FOS\UserBundle\Event\GetResponseUserEvent")
	 */
	const RESETTING_SEND_EMAIL_CONFIRM = 'magenta_user.resetting.send_email.confirm';
	 ...
	 * @Event("FOS\UserBundle\Event\GetResponseUserEvent")
	 */
	const RESETTING_SEND_EMAIL_COMPLETED = 'magenta_user.resetting.send_email.completed';
	 ...
	 * @Event("FOS\UserBundle\Event\UserEvent")
	 */
	const USER_CREATED = 'magenta_user.user.created';
	 ...
	 * @Event("FOS\UserBundle\Event\UserEvent")
	 */
	const USER_PASSWORD_CHANGED = 'magenta_user.user.password_changed';
	 ...
	 * @Event("FOS\UserBundle\Event\UserEvent")
	 */
	const USER_ACTIVATED = 'magenta_user.user.activated';
	 ...
	 * @Event("FOS\UserBundle\Event\UserEvent")
	 */
	const USER_DEACTIVATED = 'magenta_user.user.deactivated';
	 ...
	 * @Event("FOS\UserBundle\Event\UserEvent")
	 */
	const USER_PROMOTED = 'magenta_user.user.promoted';
	 ...
	 * @Event("FOS\UserBundle\Event\UserEvent")
	 */
	const USER_DEMOTED = 'magenta_user.user.demoted';
}