...
class Warranty extends FullTextSearch implements ThingChildInterface, DecisionMakingInterface, FullTextSearchInterface
{
    ...
    public function generateFullText()
    {
        ...
        if (!empty($customer)) {
            ...
            $orgName = null === $org ? 'none' : $org->getName();
        }
    ...
    public function makeDecision(
        ...
        $status = null;
        if (DecisionMakingInterface::DECISION_RESET === $decision) {
            $status = DecisionMakingInterface::STATUS_NEW;
        } elseif (DecisionMakingInterface::DECISION_APPROVE === $decision) {
            $status = DecisionMakingInterface::STATUS_APPROVED;
        } elseif (DecisionMakingInterface::DECISION_REJECT === $decision) {
    ...
    public function addReceiptImage(
        Media $image
    ) {
     ...
     */
    protected $status = DecisionMakingInterface::STATUS_NEW;
     ...
     */
    public function setProductSerialNumber(
     ...
     */
    public function setExtendedWarrantyPeriod(
     ...
     */
    public function setReceiptImages(
