...
class WarrantyCase extends FullTextSearch implements DecisionMakingInterface
{
     ...
     */
    public function setDecisionRemarks(
        ?string $decisionRemarks
    ): void {
        $this->decisionRemarks = $decisionRemarks;
    }

    public function markStatusAs(
        $status
    ) {
        switch ($status) {
    ...
    public function addServiceSheet(
        ServiceSheet $s
    ) {
    ...
    public function removeServiceSheet(
        ServiceSheet $s
    ) {
    ...
    public function addServiceNote(
        ServiceNote $note
    ) {
    ...
    public function removeServiceNote(
        ServiceNote $note
    ) {
    ...
    public function addAssigneeHistory(
        AssigneeHistory $ah
    ) {
    ...
    public function removeAssigneeHistory(
        AssigneeHistory $ah
    ) {
     ...
     */
    protected $numberMonthlyIncrement;
     ...
     */
    public function setServiceZone(
     ...
     */
    public function setServiceNotes(
     ...
     */
    public function setAssigneeHistory(
     ...
     */
    public function setAppointmentAt(
     ...
     */
    public function setServiceSheets(
