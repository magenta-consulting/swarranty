...
class MessageTemplate extends Thing {
	...
	const TYPE_WARRANTY_APPROVED = 'REGISTRATION_APPROVED';
	const TYPE_WARRANTY_NEW_REGISTRATION = 'WARRANTY_NEW_REGISTRATION';
	const TYPE_TECHNICIAN_NEW_ASSIGNMENT = 'TECHNICIAN_NEW_ASSIGNMENT';
